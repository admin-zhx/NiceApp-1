...
public class AnimatorUtils {
	...
	public static Animator animViewFadeIn(View paramView, long paramLong,
	...
	public static Animator animViewFadeOut(View paramView, long paramLong,
			Animator.AnimatorListener paramAnimatorListener) {
		ObjectAnimator localObjectAnimator = ObjectAnimator.ofFloat(paramView,
	...
	public static Animator moveScrollViewToX(View view, int toX, int time,
		...
		ObjectAnimator objectAnimator = ObjectAnimator.ofInt(view, "scrollX",
				new int[] { toX });
	 ...
	 *            动画持续时间
	 */
	public static void showBackgroundColorAnimation(View view, int preColor,
			int currColor, int duration) {
	 ...
	 * @param animatorTime
	 *            动画时间
	 * @param isStartAnimator
	 *            是否开启指示器
	 * @param isStartInterpolator
	 *            是否开始动画
	 * @return 平移动画
	 */
	public static Animator showUpAndDownBounce(View view, int translationY,
