 ...
 */
public class CardViewPagerFragment extends AbsBaseFragment implements
	...
	protected View initViews(LayoutInflater inflater) {
		...
		mRocketToHeadBtn = (ImageButton) view
				.findViewById(R.id.btn_rocket_to_head);
		mSideMenuOrBackBtn = (Button) view
				.findViewById(R.id.btn_side_menu_or_back);
		mRhythmLayout = (RhythmLayout) view.findViewById(R.id.box_rhythm);
		mPullToRefreshViewPager = (PullToRefreshViewPager) view
		...
		((RelativeLayout.LayoutParams) mPullToRefreshViewPager
	...
	private void onAppPagerChange(int position) {
		...
		// 执行颜色转换动画
		AnimatorUtils.showBackgroundColorAnimation(this.mMainView, mPreColor,
				currColor, 400);
		mPreColor = currColor;
	...
	private void toggleRocketBtn(int position) {
		if (position > 1) {
			...
			AnimatorUtils.animViewFadeOut(this.mRocketToHeadBtn).addListener(
					new Animator.AnimatorListener() {
						...
						public void onAnimationEnd(Animator paramAnimator) {
							CardViewPagerFragment.this.mRocketToHeadBtn
