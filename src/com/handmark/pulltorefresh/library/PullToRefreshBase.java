...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout
	...
	@Override
	public final com.handmark.pulltorefresh.library.ILoadingLayout getLoadingLayoutProxy(
	 ...
	 *         {@link PullToRefreshBase.Orientation#HORIZONTAL} depending on the
	 *         scroll direction.
	 */
	...
	protected com.handmark.pulltorefresh.library.internal.LoadingLayout createLoadingLayout(
			Context context, Mode mode, TypedArray attrs) {
		com.handmark.pulltorefresh.library.internal.LoadingLayout layout = mLoadingAnimationStyle
	 ...
	 */
	protected com.handmark.pulltorefresh.library.LoadingLayoutProxy createLoadingLayoutProxy(
	...
	/**
	 * Called when the UI has been to be updated to be in the
	 * {@link PullToRefreshBase.State#REFRESHING} or
	 * {@link PullToRefreshBase.State#MANUAL_REFRESHING} state.
	 * 
	 * @param doScroll
	...
	protected final void setHeaderScroll(int value) {
		...
		if (USE_HW_LAYERS) {
			...
			com.handmark.pulltorefresh.library.internal.ViewCompat
					.setLayerType(mRefreshableViewWrapper,
	...
	private void init(Context context, AttributeSet attrs) {
		...
		if (a.hasValue(R.styleable.PullToRefresh_ptrRefreshableViewBackground)) {
			...
			com.handmark.pulltorefresh.library.internal.Utils.warnDeprecation(
	...
	public static enum AnimationStyle {
		...
		com.handmark.pulltorefresh.library.internal.LoadingLayout createLoadingLayout(
				Context context, Mode mode, Orientation scrollDirection,
				TypedArray attrs) {
			switch (this) {
			case ROTATE:
			default:
				return new com.handmark.pulltorefresh.library.internal.RotateLoadingLayout(
						context, mode, scrollDirection, attrs);
			case FLIP:
				return new com.handmark.pulltorefresh.library.internal.FlipLoadingLayout(
						context, mode, scrollDirection, attrs);
			}
		}
	}
	...
	public static interface OnPullEventListener<V extends View> {
		 ...
		 * @param direction
		 *            - One of {@link PullToRefreshBase.Mode#PULL_FROM_START} or
		 *            {@link PullToRefreshBase.Mode#PULL_FROM_END} depending on
		 *            which direction the user is pulling. Only useful when
		 *            <var>state</var> is
