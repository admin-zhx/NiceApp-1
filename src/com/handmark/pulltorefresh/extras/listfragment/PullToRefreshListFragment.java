 ...
 * {@link android.support.v4.app.ListFragment}. This implementation simply
 * replaces the ListView that {@code ListFragment} creates with a new
 * PullToRefreshListView. This means that ListFragment still works 100% (e.g.
 * <code>setListShown(...)</code> ).
 * <p/>
